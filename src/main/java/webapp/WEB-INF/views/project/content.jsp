...
<body>
    ...
    <div class="wrap">
        ...
        <div class="content-container">
            ...
            <h1 class="main-title">${b.titleNum}번 게시물</h1>
    ...
    <script>
        ...
        if ($modBtn !== null) {
            $modBtn.onclick = e => {
                location.href = '/project/modify?projectNum=${b.projectNum}';
            };
        }
        ...
        if ($delBtn !== null) {
            $delBtn.onclick = e => {
                ...
                location.href = '/project/delete?projectNum=${b.projectNum}';
            };
        }
        //목록버튼
        $listBtn.addEventListener('click', e => {
            console.log('목록 클릭!');
            location.href = '/project/list?pageNum=${p.pageNum}&amount=${p.amount}'
        });
    </script>
    ...
    <script>
        ...
        $(function () {
            ...
            function getReplyList(pageNum) {
                fetch('/api/v1/reply?projectNum=' + projectNum + '&pageNum=' + pageNum)
                    .then(res => res.json())
                    .then(replyMap => {
